...
export default function Hero({
  ...
  description = 'Acme Software delivers cutting-edge AI-powered solutions that streamline operations, boost productivity, and drive measurable results for modern enterprises.',
  features = [
  ...
  imageAlt = 'Acme Software Dashboard',
